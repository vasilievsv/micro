...
{
    LL_AHB1_GRP1_EnableClock( LL_AHB1_GRP1_PERIPH_DMA1 );  // Подаем тактовые импульсы на DMA
    LL_APB2_GRP1_EnableClock( LL_APB2_GRP1_PERIPH_GPIOA ); // Шина, на которой ноги USART
    LL_APB2_GRP1_EnableClock( LL_APB2_GRP1_PERIPH_USART1 );
    
// DMA - MEMORY TO PERIPH    
